...
interface IAssist is IBEP20, IERC1363, IERC2612, IERC20Burnable, IERC20TokenRecover {
    ...
    function dividendTracker() external view returns (IAssistDividendTracker);
    ...
    function buyTeamFee() external view returns (uint256);

    function buyDevelopmentFee() external view returns (uint256);
    ...
    function sellDevelopmentFee() external view returns (uint256);

    function sellTeamFee() external view returns (uint256);
    ...
    function initializeDividendTracker(IAssistDividendTracker _dividendTracker) external;
    ...
    function updateTeamWallet(address newMarketingWallet) external;

    function updateDevelopmentWallet(address newMarketingWallet) external;
